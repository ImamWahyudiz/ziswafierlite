...
// ===== 1. Fix Zakat Parent (16) - remove generic ZAKAT keywords =====
...
console.log('Fixed Zakat Parent (16) - removed generic ZAKAT keywords');

// ===== Zakat Maal (11) - ensure SPECIFIC keywords only =====
...
const zakatMaalKeywords = ['ZAKAT MAAL', 'ZAKAT HARTA', 'ZAKAT PENGHASILAN', 'ZAKAT PROFESI', 'ZKT MAL', 'ZKT PENGHASILAN', 'Z MAAL', 'ZKT MAL', 'Z MAAL', 'PEMBERSIHAN HARTA'];
for (const k of zakatMaalKeywords) {
  if (!prog11_a.keywords.some(e => e.toUpperCase() === k.toUpperCase())) prog11_a.keywords.push(k);
}
console.log('Fixed Zakat Maal (11) keywords:', prog11_a.keywords.length);
...
for (const v of fitrahVariants) {
  if (!prog9_a.keywords.some(e => e.toUpperCase() === v.toUpperCase())) prog9_a.keywords.push(v);
}
